...
Police: Looks more highly correlated with crime than corr suggests. There are 1 or 2 outliers that look very influential. This is important, because we would expect that police would have a big impact on crime. Let's consider this variable for model 1 (simple regression) -> I think it would be important to look at the police to residuals plot here (while we always look at fitted values to residuals, this compares the entire model. )
